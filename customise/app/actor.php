...
<!DOCTYPE html>
<html lang="en-gb">
<title>Customise - Person Results</title>
<meta charset="UTF-8">
...
<div class="j-intro">
	...
	<div class="w3-container w3-content j-results" style="max-width:1400px;margin-top:20px">
	  ...
	  <div class="w3-row" id="personresults" style="display:none">
	    <div class="w3-col m3">
	      <div class="w3-card-2 j-results-border">
	        <div class="w3-container">
	         ...
	         <p class="w3-center j-results-image" id="photo"></p>
					 <div class='w3-center' id='personfave' style='display:none'>
...
<script>
	...
	var apiUrl = "http://www.myapifilms.com/imdb/idIMDB?idName=" + searchQuery + "&token=72dff507-0f89-4d9a-b53b-6f83e8d7e6ac&format=json&language=en-us&filmography=1&bornDied=0&starSign=0&uniqueName=0&actorActress=0&actorTrivia=0&actorPhotos=0&actorVideos=0&salary=0&spouses=0&tradeMark=0&fullSize=0";
